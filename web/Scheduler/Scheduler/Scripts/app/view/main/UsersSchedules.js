Ext.define('Main.view.main.UsersSchedules', {
    extend: 'Ext.window.Window',
    alias: 'widget.UsersSchedules',
    width: 800,
    ...
    initComponent: function () {
        ...
        var store = Ext.create('Ext.data.Store', {
            autoLoad: true,
            fields: ['EndDate' , 'Id', 'Location', 'Notes',  'StartDate', 'Title', 'Type','User'],
            pageSize: 25, // items per page
            proxy: {
                type: 'ajax',
                url: 'Main/GetAllUserSchedules',  // url that will load data with respect to start and limit params
                reader: {
                    type: 'json',
                    root: 'data',
                    totalProperty: 'total'
